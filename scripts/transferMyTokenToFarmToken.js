...
module.exports = async function (callback) {
	...
	console.log(
		"Amount of MyToken FarmToken is allowed to transfer on our behalf After:" + allowanceAfter.toString()
		)
	...
	console.log(
		"Balance MyToken Before TokenFarm" + web3.utils.fromWei(balanceMyTokenBeforeFarmToken.toString())
		)
	...
	console.log(
		"Balance FarmToken Before TokenFarm" + web3.utils.fromWei(balanceFarmTokenBeforeFarmToken.toString())
		)
	...
	console.log(
		"Balance MyToken Before TokenFarm" + web3.utils.fromWei(balanceMyTokenAfterFarmToken.toString())
		)
	console.log("*** Farm Token ***")
	...
	console.log(
		"Balance FarmToken After TokenFarm" + web3.utils.fromWei(balanceFarmTokenAfterFarmToken.toString())
		)
	callback()
